...
const LoginScreen = ({ navigation }) => {
  ...
  return (
    ...
    >
      <Text
        style={[
          formatTextStyle({ color: "#fff", fontSize: 24, fontWeight: "700" }),
          { textAlign: "center", marginBottom: 60 },
        ]}
        accessibilityLabel="Halaman login"
        accessible
      >
        Login
      </Text>
      ...
      <Button
        text="Login"
        style={{ width: 239, alignSelf: "center", marginVertical: 40 }}
